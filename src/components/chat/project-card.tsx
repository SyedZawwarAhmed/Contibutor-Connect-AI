...
// export function ProjectCard({ project, enhanced = false }: ProjectCardProps) {
//   const getDifficultyColor = (difficulty?: string) => {
//     switch (difficulty) {
//       case "beginner":
...
//   return (
//     <Card className="border-border/50 bg-card/50 backdrop-blur hover:shadow-lg transition-all duration-200">
//       <CardHeader className="pb-3">
//         <div className="flex items-start justify-between">
...
//       <CardContent className="space-y-3">
//         {/* Difficulty Level (Enhanced Mode) */}
//         {enhanced && project.difficulty && (
...
//         {/* Contribution Types (Enhanced Mode) */}
//         {enhanced &&
//           project.contributionTypes &&
//           project.contributionTypes.length > 0 && (
//             <div className="space-y-2">
